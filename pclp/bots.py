...
db =_mysql.connection(host="localhost",user="root",passwd="change_me",db="pclp")
#i = 0
while True:
	try:
		...
		for i in list1:
			data = i.split(".")
			db.query("UPDATE pc_submit SET SCORE = '"+data[2]+"', STATUS_ID = '"+data[3]+"', SUBMIT_LOG = '"+data[4]+"' WHERE SUBMIT_HASH ='"+data[1]+"'")
