...
class Clarificationmodel extends CI_Model {
    ...
    function saveToDb($pid, $ctitle, $ccontent)
	{
		$data = array(
					   'participant_id' => $pid ,
	...
	function getAllClarificationComplete($conid)
	{
		$parid = $this->session->userdata('participantid');
		$q = '
			SELECT pcu.user_name,
	...
	function answer($clarification, $ans)
	{
		$data = array(
	...
	function getAllClarificationContest($contestid)
	{
		$q = '
			SELECT pcu.user_name,
