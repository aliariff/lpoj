					...
					<div id="content-text">
						...
						<p>
							<?php
								...
								$defaultHeight = 50;
								$height = $defaultHeight + ($this->Contestmodel->getParticipantNumberContest($id) * $defaultHeight);
								if ($height > 500) $height = 500;
							?>
							<iframe frameborder='0' src="<?php echo site_url('/liverank'); ?>" width='100%' height="<?php echo $height; ?>" border='0' ></iframe>
						</p>
						<br /><hr /><br />
